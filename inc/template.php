...
class template
{
	...
	*/
	function set_template()
	{
		...
		if (file_exists(MAINDIR . 'themes/' . $theme))
		{
			$this->root = MAINDIR . 'themes/' . $theme;
			$this->cachepath = MAINDIR . 'cache/tpl_' . str_replace('_', '-', $theme) . '_';
			$this->default_root = MAINDIR . 'themes/default';
			$this->default_cachepath = MAINDIR . 'cache/tpl_default' . '_';
		}
		else
		{
	...
	*/
	function set_custom_template($template_path, $template_name)
	{
		...
		$this->cachepath = MAINDIR . 'cache/ctpl_' . str_replace('_', '-', $template_name) . '_';
	...
	*/
	function _tpl_load(&$handle)
	{
		...
		{
			include(INCDIR . 'class_template_compile.php');
		}
