...
<div class="narrow-centre-block">
  ...
  <div class="subscription-box">
    ...
    @else
    <form class="form-horizontal" action="{{ route('postPremium') }}" method="post" id="payment-form">
      ...
      <div class="form-group">
        {{ csrf_field() }}
        <input type="submit" id="submit" class="btn btn-default btn-lg" value="Submit Payment">
      </div>
    </form>
    @endif
  </div>
